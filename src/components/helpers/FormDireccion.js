        ...
        <div style={{ margin: "15%" }}>
            <FormControl fullWidth>
                ...
                <div style={{ display: "flex" }}>
                    <TextField label="Calle" required error={props.error?.calle ? true : false} value={props.contexto.calle} helperText={props.error?.calle} onChange={handleOnCalleChange} sx={{ width: "75%", margin: "10px 10px 15px 0px" }} />
                    <TextField label="Número" required error={props.error?.nro ? true : false} value={props.contexto.nro} helperText={props.error?.nro} type="number" onChange={handleOnNroChange} sx={{ margin: "10px 0px 15px 10px" }} />
                </div>
